...
let TARGET_WH = ((target-Shelly.getComponentStatus("number:200").value)/100*kapa/eff);
...
if (LOG) { print("Intelligente Ladebegrenzung aktiv. Schwelle:", DROP_THRESHOLD); }-CV-Knie) laufend nachfuehren
if (power > peakPower) { peakPower = power; }
